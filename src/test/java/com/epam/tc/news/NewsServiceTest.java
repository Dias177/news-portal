...
//        News news1 = new News(id1, userId, title1, date1, brief1, content1);
//
//        long id2 = 2L;
//        Long userId2 = 2L;
...
//        News news2 = new News(id2, userId2, title2, date2, brief2, content2);
//
//        news.add(news1);
//        news.add(news2);
//
...
//        News news = new News(id, userId3, title, date, brief, content);
//
...
//        News news = new News(id, userId4, title, date, brief, content);
//
...
//        News news = new News(id, userId5, title, date, brief, content);
//
